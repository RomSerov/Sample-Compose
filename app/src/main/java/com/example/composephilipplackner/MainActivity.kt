                    ...
                    bottomBar = {
                        BottomNavBar(
                            items = listOf(
                                ...
                                BottomNavItem(name = "Chat", route = "chat", icon = Icons.Default.Notifications, badgeCount = 23),
                                BottomNavItem(name = "ettings", route = "settings", icon = Icons.Default.Settings)
                            ),
